      ...
      <div className="mx-auto grid h-full max-w-lg grid-cols-5">
        ...
        <div className="flex items-center justify-center">
          <button
            ...
            type="button"
            className="group inline-flex h-10 w-10 items-center justify-center rounded-full bg-amber-600 font-medium hover:bg-amber-700 focus:outline-none focus:ring-4 focus:ring-amber-300 dark:focus:ring-amber-800"
          >
            <svg
